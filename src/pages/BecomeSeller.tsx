      ...
      <section className="relative bg-gradient-to-r from-sky-600 to-sky-700 text-white py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full mb-4 sm:mb-6">
            ...
            <span className="text-xs sm:text-sm text-white">Join 250+ Authorized Local Sellers & Premium Brands</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-4xl mx-auto mt-6 sm:mt-10 px-4">
            <div className="bg-white/10 backdrop-blur-md border border-white/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-left">
              ...
              <h3 className="text-lg sm:text-xl text-white mb-2">Sell Brand-Name Products</h3>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-left">
              ...
              <h3 className="text-lg sm:text-xl text-white mb-2">Offer Local Services</h3>
              <p className="text-sky-100 text-xs sm:text-sm">
              ...
              return (
                <div key={item.step} className="flex-1 flex items-center">
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <span className={`text-[10px] sm:text-xs mt-1 sm:mt-2 hidden sm:block ${
          ...
          {currentStep === 'search' && (
            ...
            >
              <div className="bg-white border-2 border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                <h2 className="text-xl sm:text-2xl md:text-3xl text-gray-900 mb-3 sm:mb-4">Step 1: Find Your Business</h2>
                  ...
                  <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                    {isSearching && (
                      <div className="text-center py-6 sm:py-8">
                        ...
                        <p className="text-xs sm:text-sm text-gray-600">Searching businesses...</p>
                      </div>
                    )}
                    ...
                    {!isSearching && searchError && (
                      <div className="bg-red-50 border border-red-200 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center">
                        ...
                        <p className="text-xs sm:text-sm text-red-800">{searchError}</p>
                      </div>
                    )}
                    
                    {!isSearching && !searchError && searchResults.length > 0 && (
                      <>
                        <h3 className="text-xs sm:text-sm text-gray-600">Found {searchResults.length} matching businesses</h3>
                        {searchResults.map((listing) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <h4 className="text-sm sm:text-base text-gray-900 mb-0.5 sm:mb-1 truncate">{listing.name}</h4>
                              <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-gray-600">
                                <MapPin className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                                <span className="truncate">{listing.address}</span>
                              </div>
                              <div className="text-[10px] sm:text-xs text-gray-500 mt-0.5 sm:mt-1 truncate">{listing.category}</div>
                            </div>
                    ...
                    {!isSearching && !searchError && searchResults.length === 0 && (
                      <div className="bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl p-6 sm:p-8 text-center">
                        ...
                        <p className="text-sm sm:text-base text-gray-600 mb-1 sm:mb-2">No businesses found matching "{searchQuery}"</p>
                        <p className="text-xs sm:text-sm text-gray-500">Try a different search or create a new listing below</p>
                      </div>
                    )}
                  </div>
                )}
                  ...
                  <div className="bg-gradient-to-br from-sky-50 to-blue-50 border-2 border-sky-200 rounded-lg sm:rounded-xl p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-base sm:text-lg text-gray-900 mb-1 sm:mb-2">Don't see your business?</h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6">
                  ...
                  <h3 className="text-base sm:text-lg text-gray-900 mb-1 sm:mb-2">Premium Positioning</h3>
                ...
                <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6">
                  ...
                  <h3 className="text-base sm:text-lg text-gray-900 mb-1 sm:mb-2">Verified Badge</h3>
                  <p className="text-xs sm:text-sm text-gray-600">
                ...
                <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6 sm:col-span-2 md:col-span-1">
                  ...
                  <h3 className="text-base sm:text-lg text-gray-900 mb-1 sm:mb-2">Community Support</h3>
                  <p className="text-xs sm:text-sm text-gray-600">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8">
                  ...
                  <div className="bg-sky-50 border border-sky-200 rounded-lg sm:rounded-xl p-3 sm:p-4 mb-6 sm:mb-8">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0">
                        <h4 className="text-sm sm:text-base text-gray-900 mb-0.5 sm:mb-1 truncate">{selectedListing.name}</h4>
                        <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-gray-600">
                          <MapPin className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                          <span className="truncate">{selectedListing.address}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    ...
                    <Input placeholder="e.g., Fleet Feet Sports Boston" className="mt-1 sm:mt-2" />
                  </div>

                  {/* Business Type */}
                  <div>
                    <Label>Business Type *</Label>
                    <select className="w-full mt-1 sm:mt-2 px-3 sm:px-4 py-2 text-sm sm:text-base border-2 border-gray-300 rounded-lg focus:outline-none focus:border-sky-500">
                  ...
                  <div>
                    ...
                    <Input placeholder="123 Main Street" className="mt-1 sm:mt-2 mb-2" />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                      ...
                      <Input placeholder="(617) 555-0123" className="mt-1 sm:mt-2" />
                    </div>
                    <div>
                      <Label>Business Email *</Label>
                      <Input type="email" placeholder="info@business.com" className="mt-1 sm:mt-2" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Input placeholder="https://www.yourbusiness.com" className="mt-1 sm:mt-2" />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg sm:rounded-xl p-6 sm:p-8 text-center hover:border-sky-500 transition-colors cursor-pointer">
                      <Upload className="w-10 h-10 sm:w-12 sm:h-12 text-gray-400 mx-auto mb-3 sm:mb-4" />
                      <p className="text-sm sm:text-base text-gray-600 mb-1 sm:mb-2">Click to upload or drag and drop</p>
                      <p className="text-xs sm:text-sm text-gray-500">PDF, JPG, PNG (Max 10MB)</p>
                    </div>
                  </div>
                </div>
