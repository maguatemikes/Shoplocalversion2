      ...
      <section className="bg-gradient-to-r from-sky-600 to-sky-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-sky-100">
            Get verified as an authorized retailer and reach more customers on
            WFE
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            {[
              ...
              const isCompleted =
                ["search", "verify", "link"].indexOf(currentStep) >
                ["search", "verify", "link"].indexOf(item.step as any);
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Search for your business listing to get started. If you don't
                  find it, you can create a new listing.
                </p>
          ...
          {currentStep === "verify" && selectedListing && (
            ...
            >
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-8">
                ...
                <p className="text-gray-600 mb-6">
                  To claim this listing, please verify that you are authorized
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      ...
                      license, partnership agreement, etc.)
                    </p>
          ...
          {currentStep === "link" && (
            ...
            >
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-8">
                <h2 className="text-2xl text-gray-900 mb-4">
                  Link Vendor Account (Optional)
                </h2>
                <p className="text-gray-600 mb-6">
                  Connect your GeoDirectory business listing with a Dokan vendor
                  account to sell products online.
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="border-2 border-gray-200 rounded-xl p-6 hover:border-sky-500 transition-colors cursor-pointer">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-gray-900 mb-1">
                          Link Existing Vendor Account
                        </h4>
                        <p className="text-sm text-gray-600">
                          Already selling on WFE? Connect your existing Dokan
                          store
                        </p>
                      </div>
                      <ArrowRight className="w-5 h-5 text-gray-400" />
            ...
            >
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 text-center">
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                  ...
                  <strong>{selectedListing?.name}</strong>. Our team will review
                  your submission and verify your authorization within 3-5
                  business days.
                </p>
                ...
                <div className="bg-sky-50 border border-sky-200 rounded-xl p-6 mb-8 text-left max-w-2xl mx-auto">
                  ...
                  <ol className="space-y-3 text-sm text-gray-700">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Our verification team reviews your submitted
                        documentation
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        You'll receive an email confirmation with your verified
                        badge
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Access your dashboard to manage your listing and start
                        selling
                      </span>
                    </li>
                  </ol>
