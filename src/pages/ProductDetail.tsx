...
import {
  getProductDetail,
  getNearbyVendors,
  getShortProductDetail,
} from "../api/woo/products";
...
export function ProductDetail({ productSlug }: ProductDetailProps) {
  ...
  const [product_item, setProducItem] = useState({
    ...
    id: "10236",
    image:
      "https://shoplocal.kinsta.cloud/wp-content/uploads/2025/11/cropped-pi4805000_ff_4805191-7b50b9ecf03784511cf9_full.jpg",
    isNew: false,
    isTrending: false,
  ...
  const [product, setProduct] = useState({
    ...
    description:
      "100% organic cotton t-shirt. Perfect for custom printing and embroidery.",
  ...
  const getAvailableOptions = (variations, selectedAttributes) => {
    ...
    const attributeKeys = Object.keys(variations[0].attributes).map((k) =>
      k.replace(/^pa_/, "")
    );
  ...
  const handleAttributeChange = (attrName, value) => {
    ...
    setAvailableOptions(
      getAvailableOptions(product_item.variations, newSelected)
    );
  };
  ...
  const handleVariationChange = (selectedAttrs) => {
    ...
    const matched = product_item.variations.find((v) =>
      Object.keys(selectedAttrs).every((key) => {
        ...
        const variationValue = v.attributes[wcKey]
          ? normalize(v.attributes[wcKey])
          : "";
            ...
            <div>
              <div className="sticky top-24">
                ...
                <div className="aspect-square rounded-2xl overflow-hidden bg-gray-100 mb-4">
                  <ImageWithFallback
                    src={
                      ...
                      xtraData.gallery_images.length > 0
                        ? [
                ...
                <div className="grid grid-cols-4 gap-4">
                  {Array.isArray(xtraData?.gallery_images) ? (
                    [xtraData.featured_img, ...xtraData.gallery_images].map(
                      (img, idx) => (
                        <button
                          key={idx}
                ...
                <div className="flex items-center gap-1">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`w-5 h-5 ${
                        i < Math.floor(xtraData.average_rating)
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-3 mb-2">
                  <span className="text-4xl text-gray-900">
                    ${product_item.price.toFixed(2)}
                  </span>
                  {product_item.originalPrice &&
                    product_item.originalPrice > 0 &&
                    product_item.originalPrice > product_item.price && (
                      <>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-600">
                    Available: {product_item.stock} units
                  </span>
                </div>
              </div>
                ...
                <AccordionItem value="shipping">
                  ...
                  <AccordionContent>
                    <div className="space-y-4 pt-2 text-gray-600">
                      <p>
                        This product ships from the seller's warehouse in
                        California, USA.
                      </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    {[
                      {
                        label: "Category",
                        value: product_item.category || "Uncategorized",
                      },
                      {
                        label: "Brand",
                        value: product_item.brand || "Unknown Brand",
                      },
                  ...
                  <div className="space-y-3">
                    {[
                      {
                        label: "Vendor",
                        value: product_item.vendor || "Default Vendor",
                      },
                      { label: "Price", value: `$${product_item.price}` },
                      {
                        label: "Original Price",
                        value: product_item.originalPrice
                          ? `$${product_item.originalPrice}`
                          : "-",
                      },
                      {
                        label: "Accepts Offers",
                        value: product_item.acceptsOffers ? "Yes" : "No",
                      },
                    ].map((item, idx) => (
                      <div
                        key={idx}
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6">
                      <div
                        className="prose"
                        dangerouslySetInnerHTML={{
                          __html: xtraData.care_maintenance,
                        }}
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mb-3">
                          ...
                          retailers near you. Support local businesses while
                  ...
                  <div className="space-y-4">
                    {vendors.map((store, index) => {
                      ...
                      const address = `${addressObj.street_1 || ""}${
                        addressObj.street_2 ? ", " + addressObj.street_2 : ""
                      }, ${addressObj.city || ""}${
                      ...
                      const weeklyHours = weekdays
                        .map((day) => {
                          ...
                          return `${
                            day.charAt(0).toUpperCase() + day.slice(1)
                          }: ${dayInfo.opening_time.join(
                            ", "
                          )} - ${dayInfo.closing_time.join(", ")}`;
                        })
                        ...
                        >
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="text-right">
                              <div className="text-sky-600 mb-1">
                                {store.distance_miles.toFixed(1)} miles
                              </div>
                              <div className="text-sm text-gray-600 ">
                                {weeklyHours}
                              </div>
                          ...
                          <div className="flex gap-3">
                            <Button
                              ...
                              onClick={() =>
                                navigate(
                                  `/vendor-detail/${store.store_name
                                    .toLowerCase()
                                    .replace(/\s+/g, "-")}/`
                                )
                              }
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mt-6">
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                        <span>
                          Try before you buy with in-store availability
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
