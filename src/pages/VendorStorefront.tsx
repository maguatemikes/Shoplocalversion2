...
export function VendorStorefront({
  ...
  useEffect(() => {
    const fetchVendor = async () => {
      ...
      try {
        console.log(
          "🔍 Attempting to fetch vendor from API with slug:",
          vendorSlug
        );
        ...
        if (!response.ok) {
          ...
          const fallbackVendor: Vendor = {
            ...
            banner:
              "https://images.unsplash.com/photo-1556740749-887f6717d7e4?w=1200&h=400&fit=crop",
        ...
        const apiVendor: Vendor = {
          ...
          name:
            typeof place.title === "string"
              ? place.title
              : place.title?.rendered || "Unknown Vendor",
          slug: place.slug || vendorSlug,
          logo:
            place.featured_image?.thumbnail ||
            place.featured_image?.medium ||
            "https://images.unsplash.com/photo-1556740749-887f6717d7e4?w=200&h=200&fit=crop",
          banner:
            place.featured_image?.large ||
            place.featured_image?.full ||
            "https://images.unsplash.com/photo-1556740749-887f6717d7e4?w=1200&h=400&fit=crop",
          ...
          image:
            place.featured_image?.medium_large ||
            place.featured_image?.full ||
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-6 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-600">
                      {storeStats.followers.toLocaleString()} Followers
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
